function geometry_3Dplot_src( varargin)%figno, hop, snx_vec, sny_vec, snz_vec )
...
[x,y,z] = meshgrid(dx*(0:nx-1),dy*(0:ny-1),dz*(0:nz-1));
    ...
    if strcmp(BCPlot,'y')
        ...
        hold on;
        plot3(dx*snx_vec(1:hop:end),dy*sny_vec(1:hop:end),dz*snz_vec(1:hop:end),'r*' ); colormap(flipud(gray))
